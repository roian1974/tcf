class ETSentiment:
    ...
    def setTargetScore(self,targetScore):
        self.targetScore = targetScore

    def setUseYN(self,useYN):
        self.useYN = useYN
    ...
    def setColumn(self,articleID,label,registerDate,targetScore,modifyDate,useYN,target):
        self.registerDate = registerDate
        self.articleID = articleID
        self.label = label
        self.modifyDate = modifyDate
    ...
    def toString(self):
        print ( 'id-' + self.articleID +',label-' + self.label + ',regiseterdate-' + self.registerDate  + 'targetscore-' + self.targetScore + 'useyn-' + self.useYN )
