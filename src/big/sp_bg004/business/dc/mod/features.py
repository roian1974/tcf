...
def getFeatureWithName(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
        ...
        big4000cdto.ddto['picname'] = 'Feature-Name-Surived'
        graph.bar_chart('Title',big4000cdto.ddto['trainpd'])
...
def getFeatureWithSex(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
...
def getFeatureWithAge(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
...
def getFeatureWithBinning(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
...
def getFeatureWithFare(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
...
def getFeatureWithCabin(big4000cdto) :
    try:
        rtn = True
        train_l = [ big4000cdto.ddto['trainpd'] ]
        train = big4000cdto.ddto['trainpd']
...
def getFeatureWithFamilysize(big4000cdto):
    try:
        rtn = True
        train_l = [big4000cdto.ddto['trainpd']]
        train = big4000cdto.ddto['trainpd']
