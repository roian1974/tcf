...
def train(modelType, train, trainheadlines) :
    try:
        ...
        moutfile="C:\jDev\MyWorks\PycharmProjects\Roian\log\input\\big\\" + "mod.svmg." + comutil.getsysdate()
        voutfile = "C:\jDev\MyWorks\PycharmProjects\Roian\log\input\\big\\" + "vec.svmg." + comutil.getsysdate()
