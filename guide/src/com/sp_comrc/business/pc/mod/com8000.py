...
def COM8000() :
    ...
    try:
        ...
        while True :
            ...
            comlogging.logger.info( "COM8000_start() start ")
            comlogging.logger.info("")
            comlogging.logger.info("")
            ...
            if rows == False or rows == 1403 :
                ...
                for r2ow in job_r2ows :
                    ...
                    thread = threading.Thread(target=subprocessor_exe, args=(r2ow, queue,t_cnt,))
        ...
        comlogging.logger.error( 'COM8000-'+ str(err))
        include.setErr('ECOM8000', 'COM8000' + str(err))

    else:
        comlogging.logger.info( 'COM8000-성공')
    finally:
