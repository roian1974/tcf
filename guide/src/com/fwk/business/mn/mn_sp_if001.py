...
from src.com.fwk.business.mn.action import spaction
from src.com.fwk.business.mn.action import sjfaction
from src.com.fwk.business.mn.action import ejfaction
...
def MN_SP_if001():
    ...
    comlogging.logger.info("MN_SP_if001 모듈시작")
    ...
    try:
        ...
        comlogging.logger.error( 'MN_SP_if001 에서 발생 :' + str(err))
        include.setErr('ECOM001', 'TCF Error-' + str(err))
    else:
        comlogging.logger.info( "SUS:F[" + 'MN_SP_if001' + ']함수 호출성공')
    finally:
...
def tpsvrinit(argv):
    ...
    comlogging.logger.info( "============================================= MN_SP_if001() s")
...
def commandmain() :
    ...
    if rtn == False:
        ...
        MN_SP_if001()
    tpsvrdone()
    comlogging.logger.info( "============================================= MN_SP_if001() e")
