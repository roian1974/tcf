...
def TCF_SP_bg001():
    ...
    comlogging.logger.info("TCF_SP_bg001 모듈시작")
    ...
    try:
        ...
        comlogging.logger.error( 'TCF_SP_bg001 에서 발생 :' + str(err))
        include.setErr('ECOM001', 'TCF Error-' + str(err))
    else:
        comlogging.logger.info( "SUS:F[" + 'TCF_SP_bg001' + ']함수 호출성공')
    finally:
...
def tpsvrinit(argv):
    ...
    comlogging.logger.info( "============================================= TCF_SP_bg001() s")
...
def commandmain() :
    ...
    if rtn == False:
        ...
        TCF_SP_bg001()
    tpsvrdone()
    comlogging.logger.info( "============================================= TCF_SP_bg001() e")
    comlogging.logger.error("============================================= TCF_SP_bg001() e")
