...
def train(modelType, train, trainheadlines) :
    try:
        ...
        moutfile="C:\jDev\MyWorks\PycharmProjects\Roian\log\input\\big\\" + "mod.svml." + comutil.getsysdate()
        voutfile = "C:\jDev\MyWorks\PycharmProjects\Roian\log\input\\big\\" + "vec.svml." + comutil.getsysdate()
